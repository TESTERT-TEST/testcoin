...
# Убраны проблемные флаги -mcpu=apple-m1 которые вызывают ошибку компиляции
export CXXFLAGS="-DSSE2NEON_SUPPRESS_WARNINGS -O2 \
...
export CFLAGS="-DSSE2NEON_SUPPRESS_WARNINGS -O2"
